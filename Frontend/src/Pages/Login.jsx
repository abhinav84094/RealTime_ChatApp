                ...
                <form onSubmit={handleLogin}
                 className='w-full py-[20px] flex flex-col gap-[30px] items-center justify-center'>
                    ...
                    <input type='email' onChange={(e)=>setEmail(e.target.value)} value={email}
                     placeholder='Email' className='w-[90%] outline-none h-[50px] border-2 border-[#20c7ff]
                     px-[20px] py-[10px] bg-[white] rounded-lg shadow-gray-400 shadow-lg text-gray-700 text-[19px]'  />
                    <div className='relative w-[90%] h-[50px] border-2 border-[#20c7ff] overflow-hidden rounded-lg shadow-gray-400 shadow-lg  '>
                    ...
                    <button disabled={loading} type='submit' className='px-[20px] py-[10px] bg-[#20c7ff] rounded-2xl shadow-gray-300 shadow-lg 
                     text-[20px] w-[200px] mt-[20px] font-semibold hover:shadow-inner '>Login</button>
                    <p className='cursor-pointer'>New User ? <span onClick={()=>navigate("/signup")} className='text-[#20c7ff] text-[bold] text-bold' >Sign Up</span></p>
                </form>
            </div>
